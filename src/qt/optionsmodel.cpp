...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeSumcoinAmount"))
        settings.setValue("nAnonymizeSumcoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeSumcoinAmount = settings.value("nAnonymizeSumcoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeSumcoinAmount"))
        SoftSetArg("-anonymizeSumcoinamount", settings.value("nAnonymizeSumcoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeSumcoinAmount:
            nAnonymizeSumcoinAmount = value.toInt();
            settings.setValue("nAnonymizeSumcoinAmount", nAnonymizeSumcoinAmount);
            emit anonymizeSumcoinAmountChanged(nAnonymizeSumcoinAmount);
            break;
        default:
            break;
        }
